...
#  tests.append(chrx_hg17_ceu_test);
  ...
  snpcol_bad_test = Test("--metal tests/data/HDL_ONE_Eur_b36.tbl --refsnp rs10401969 
  gold9 = Test("--prefix gold9 --metal tests/data/HDL_ONE_Eur_b36.tbl --gene TCF7L2 --pvalcol GC.Pvalue --flank 600kb --plotonly --prefix dot_sizes showAnnot=F smallDot=.5 bigDot=2 weightCol=weight");
